...
function displayWeather(data) {
  ...
  weatherResults.innerHTML = `
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 pb-6 border-b border-blue-100">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900 mb-1">${data.name}, ${data.sys.country}</h2>
                ...
                <div class="mb-8">
                    <div class="text-6xl font-black bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent mb-2">${data.main.temp.toFixed(0)}°C</div>
                    <div class="text-2xl text-gray-700 flex items-center gap-2">${weatherInfo.text}</div>
      ...
      weatherResults2.innerHTML = `
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div class="flex items-start gap-4">
                                <div class="text-3xl text-cyan-500 flex-shrink-0 mt-1"><i class='bx bx-thermometer'></i></div>
                                <div>
                                    <p class="text-gray-600 text-sm mb-1">Feels Like</p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-gray-600 text-sm mb-1">Humidity</p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-gray-600 text-sm mb-1">Wind Speed</p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-gray-600 text-sm mb-1">Precipitation</p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-gray-600 text-sm mb-1">Rain Chance</p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-gray-600 text-sm mb-1">Sunrise</p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-gray-600 text-sm mb-1">Sunset</p>
